...
class SaveLODs(bpy.types.Operator):
    bl_idname = "object.save_lods"
    bl_label = "Save LODs"
...
class LODPanel(bpy.types.Panel):
    ...
    def draw(self, context):
        ...
        row = layout.row()
        row.operator("object.save_lods", text="Save LODs")
        row = layout.row()
...
def register():
    ...
    bpy.utils.register_class(SaveLODs)
...
def unregister():
    ...
    bpy.utils.unregister_class(SaveLODs)
